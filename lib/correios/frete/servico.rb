  ...
  module Frete
    class Servico
      ...
      AVAILABLE_SERVICES = {
        ...
        "03298" => { :type => :pac_agencia,                 :name => "PAC AG",         :description => "PAC contrato agencia"              },
        ...
        "03220" => { :type => :sedex_agencia,               :name => "SEDEX AG",       :description => "SEDEX contrato agencia"            },
        ...
        "04227" => { :type => :mini_envio,                  :name => "Mini Envio",     :description => ""   }
      }.freeze
